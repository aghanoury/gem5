...
system.cpu = DerivO3CPU()  # use the out-of-order model

if args.fast_forward:
    system.cpu = AtomicSimpleCPU()
    system.cpu.max_insts_any_thread = args.fast_forward
    # system.cpu.fast_forward = args.fast_forward

if args.max_instructions:
    system.cpu.max_insts_any_thread = args.max_instructions
